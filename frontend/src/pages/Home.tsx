      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        ...
        <div className="text-center mb-20">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-6">
            Welcome to{' '}
            <span className="bg-linear-to-r from-purple-600 via-blue-500 to-purple-600 bg-clip-text text-transparent bg-300% animate-gradient">
              RAGFusion
            </span>
          </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-20">
          {FEATURES.map((feature, index) => (
            ...
            >
              <div className="absolute inset-0 bg-linear-to-br from-purple-600/5 to-blue-600/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity" />
              
              <div className="relative flex flex-col items-center text-center">
                <div className="w-14 h-14 bg-linear-to-br from-purple-100 to-blue-100 dark:from-gray-700 dark:to-gray-600 rounded-xl flex items-center justify-center text-purple-600 dark:text-purple-300 mb-4 shadow-sm group-hover:scale-110 transition-transform duration-300">
                  {feature.icon}
                </div>
        ...
        <div className="relative rounded-3xl overflow-hidden">
          <div className="absolute inset-0 bg-linear-to-r from-purple-600 to-blue-600 opacity-90"></div>
